...
namespace SmartBusinessWeb.Controllers
{
    ...
    */
        ...
        public ActionResult PreSalesLns()
        {
            long salesId = 1;
            ViewData["PreSalesLns"] = SqlConnection.Query<PreSalesLn>(@"EXEC dbo.GetPreorderById @apId=@apId,@salesId=@salesId", new { apId, salesId }).ToList();
            return View();
        }
...
<version><![CDATA[2.0]]></version>
    ...
    public class PreSalesLn1
    {
        public long rtlUID { get; set; }
        public string rtlSalesLoc { get; set; }
        public string rtlCode { get; set; }
        public Nullable<byte> rtlSeq { get; set; }

        public string rtlItemCode { get; set; }
        public string rtlDesc { get; set; }
        public string rtlStockLoc { get; set; }

        public bool rtlHasSn { get; set; }

        public Nullable<decimal> rtlTaxPc { get; set; }

        public Nullable<decimal> rtlLineDiscPc { get; set; }
        public Nullable<int> rtlQty { get; set; }

        public Nullable<decimal> rtlSalesAmt { get; set; }

        public Nullable<decimal> rtlSellingPrice { get; set; }


        public Nullable<int> JobID { get; set; }

        public long rtsUID { get; set; }
        public string rtsSalesLoc { get; set; }
        public string rtsDvc { get; set; }
        public string rtsCode { get; set; }
        public string rtsRefCode { get; set; }
        public string rtsType { get; set; }
        public string rtsStatus { get; set; }
        public System.DateTime rtsDate { get; set; }

        public int rtsCusID { get; set; }

        public Nullable<decimal> rtsLineTotalPlusTax { get; set; }
        public Nullable<decimal> rtsFinalDisc { get; set; }
        public Nullable<decimal> rtsFinalDiscAmt { get; set; }

        public Nullable<decimal> rtsFinalTotal { get; set; }

        public string rtsUpldBy { get; set; }
        public DateTime? rtsUpldTime { get; set; }

        //public string rtsInternalRmks { get; set; }
        public bool rtsMonthBase { get; set; }
        public bool rtsEpay { get; set; }

        public string rtsReviewUrl { get; set; }
        public bool rtsSendNotification { get; set; }
        public bool rtsCheckout { get; set; }
        public string rtsCheckoutPortal { get; set; }
        ...
        public string itmNameDesc { get { return itmUseDesc ? itmDesc : itmName; } }
        public int itmItemID { get; set; }

        public bool itmUseDesc { get; set; }
        public Nullable<decimal> itmTaxPc { get; set; }
        public string itmBaseUnit { get; set; }
        public string itmSellUnit { get; set; }
        public Nullable<decimal> itmLastSellingPrice { get; set; }
        public decimal itmBaseSellingPrice { get; set; }
        public decimal? rtpPayAmt { get; set; }

        public string rtpPayType { get; set; }
        public decimal? rtpExRate { get; set; }
        public DateTime rtsTime { get; set; }

        public string rtsRmks { get; set; }
        public string rtsInternalRmks { get; set; }
