        ...
        public async Task<ActionResult> DoExportFrmShopAsync(DayEndsModel model, FormCollection formCollection)
        {
            ...
            switch (type)
            {
                ...
                case "purchase":
                    ...
                    HandleExcludedOrders(FileType.PurchaseOrder, dmodel);
                    break;
                case "item":
            ...
            {
                string.Concat(msg, "<br>", Resources.Resource.PurchaseOrdersNotIntegratedDueToUnsynsSuppliers);
                excludedpos = 1;
            }

            return Json(new { msg, PendingInvoices = ret, ExcludedInvoices = excludedinvoices, ExcludedPOs=excludedpos, offlinemode = 0 });
        }
